...
VALUES 	('Live in Texas', '2003-11-18'),
		('Road to Revolution: Live at Milton Keynes', '2008-06-29'),
	-- Slipknot 
		('Slipknot', '1999-06-29'),
		('Iowa', '2001-08-28'),
	-- Eminem 
...
VALUES	('Don''t Stay', 188, 1),
	...
	-- Disturbed
		...
		('Prayer', 218, 10),
	-- Poets of the Fall
		('Carnival of Rust', 262, 11),
		('Lift', 330, 12),
	-- Sabaton
		('Night Witches', 193, 13),
		('Sparta', 264, 14),
	-- Skillet 
		('Awake and Alive', 211, 15),
		('Rebirthing', 233, 16);

-- COLLECTIONS
INSERT INTO collections ("name", release_year)
VALUES 	('Light', '2022-12-02'),
		('Hard', '2022-12-02'),
		('Pop', '2022-12-02'),
		('For racing', '2022-12-02'),
